...
export const UsageDashboard: React.FC<UsageDashboardProps> = ({ onBack }) => {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      >
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between px-2 sm:px-4 py-3 gap-3 sm:gap-0">
        ...
        {loading ? (
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              {/* Total Cost Card */}
              <Card className="p-3 sm:p-4 shimmer-hover">
                <div className="flex items-center justify-between">
                  ...
                  <DollarSign className="h-6 w-6 sm:h-8 sm:w-8 text-muted-foreground/20 rotating-symbol flex-shrink-0" />
                </div>
              </Card>
              ...
              <Card className="p-3 sm:p-4 shimmer-hover">
                <div className="flex items-center justify-between">
                  ...
                  <FileText className="h-6 w-6 sm:h-8 sm:w-8 text-muted-foreground/20 rotating-symbol flex-shrink-0" />
                </div>
              </Card>
              ...
              <Card className="p-3 sm:p-4 shimmer-hover">
                <div className="flex items-center justify-between">
                  ...
                  <Activity className="h-6 w-6 sm:h-8 sm:w-8 text-muted-foreground/20 rotating-symbol flex-shrink-0" />
                </div>
              </Card>
              ...
              <Card className="p-3 sm:p-4 shimmer-hover">
                <div className="flex items-center justify-between">
                  ...
                  <TrendingUp className="h-6 w-6 sm:h-8 sm:w-8 text-muted-foreground/20 rotating-symbol flex-shrink-0" />
                </div>
              </Card>
            </div>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="overview" className="space-y-3 sm:space-y-4">
                <Card className="p-3 sm:p-6">
                  <h3 className="text-sm font-semibold mb-3 sm:mb-4">
                    Token Breakdown
                  </h3>
              ...
              <TabsContent value="timeline">
                <Card className="p-3 sm:p-6">
                  <h3 className="text-sm font-semibold mb-4 sm:mb-6 flex items-center space-x-2">
                      ...
                      return (
                        <div className="relative pl-6 sm:pl-8 pr-2 sm:pr-4">
                          ...
                          <div className="absolute left-0 top-0 bottom-8 flex flex-col justify-between text-xs text-muted-foreground">
                            ...
                            <span className="text-xs">
                              {formatCurrency(halfMaxCost)}
                            </span>
                            <span className="text-xs">{formatCurrency(0)}</span>
                          </div>

                          {/* Chart container */}
                          <div className="flex items-end space-x-1 sm:space-x-2 h-48 sm:h-64 border-l border-b border-border pl-2 sm:pl-4">
                            {stats.by_date
                              .slice()
                              .reverse()
                              .map((day) => {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <div className="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-10">
                                      <div className="bg-background border border-border rounded-lg shadow-lg p-2 sm:p-3 whitespace-nowrap">
                                        <p className="text-sm font-semibold">
                                          {formattedDate}
                                        </p>
